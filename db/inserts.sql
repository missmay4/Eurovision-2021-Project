...
insert into participant (country_id, name, song, year, song_link, language) values
	...
	((select id from country where name = 'Bielorrusia'), 'Galasy ZMesta', "Ya Nauchu Tebya (I'll Teach You)", 2021, 'https://youtu.be/_RMHKaIsac0', 'Ruso'),
	((select id from country where name = 'Bulgaria'), 'Victoria Georgieva', 'Growing Up is Getting Old', 2021, '', 'Inglés'),
	...
	((select id from country where name = 'Letonia'), 'Samanta Tīna', 'The Moon is Rising', 2021, '', 'Inglés'),
	((select id from country where name = 'Lituania'), 'The Roop', 'Discoteque', 2021, '', 'Inglés'),
	((select id from country where name = 'Macedonia del Norte'), 'Vasil Garvanliev', 'Here I Stand', 2021, 'https://youtu.be/HbXczPgRI7Y', 'Inglés'),
