...
insert into participant (country_id, name, song, year, song_link, language) values
	((select id from country where name = 'Albania'), 'Anxhela Peristeri', 'Karma', 2021, '', 'Albanés'),
	((select id from country where name = 'Alemania'), 'Jendrik Sigwart', "I Don't Feel Hate", 2021, '', 'Inglés y Alemán'),
	((select id from country where name = 'Armenia'), '	', '', 2021, '', ''),
	((select id from country where name = 'Australia'), 'Montaigne', '', 2021, '', ''),
	...
	((select id from country where name = 'Bélgica'), 'Hooverphonic', '', 2021, '', ''),
	...
	((select id from country where name = 'Dinamarca'), '', '', 2021, '', ''),
	((select id from country where name = 'Eslovenia'), 'Ana Soklič', 'Amen', 2021, '', 'Esloveno'),
	((select id from country where name = 'España'), 'Blas Cantó', 'Voy a quedarme', 2021, '', 'Español'),
	((select id from country where name = 'Estonia'), '', '', 2021, '', ''),
	((select id from country where name = 'Finlandia'), 'Blind Channel', 'Dark Side', 2021, '', 'Inglés'),
	((select id from country where name = 'Francia'), 'Barbara Pravi', 'Voilá', 2021, '', 'Francés'),
	((select id from country where name = 'Georgia'), 'Tornike Kipiani', 'You', 2021, 'https://youtu.be/LjNK4Xywjc4', 'Inglés'),
	((select id from country where name = 'Grecia'), 'Stefania Liberakakis', 'Last Dance', 2021, '', 'Inglés'),
	((select id from country where name = 'Irlanda'), 'Lesley Roy', 'Maps', 2021, '', 'Inglés'),
	((select id from country where name = 'Islandia'), 'Daði & Gagnamagnið', '10 Years', 2021, '', 'Inglés'),
	((select id from country where name = 'Israel'), 'Eden Alene', 'Set Me Free', 2021, '', 'Inglés y Hebreo'),
	((select id from country where name = 'Italia'), '', '', 2021, '', ''),
	...
	((select id from country where name = 'Moldavia'), 'Natalia Gordienco', 'Sugar', 2021, '', 'Inglés'),
	((select id from country where name = 'Noruega'), 'Tix', 'Fallen Angel', 2021, '', 'Inglés'),
	((select id from country where name = 'Países Bajos'), 'Jeangu Macrooy', '', 2021, '', ''),
	((select id from country where name = 'Polonia'), '', '', 2021, '', ''),
	((select id from country where name = 'Portugal'), '', '', 2021, '', ''),
	((select id from country where name = 'Reino Unido'), 'James Newman', '', 2021, '', 'Inglés'),
	((select id from country where name = 'República Checa'), 'Benny Cristo', 'Omaga', 2021, '', 'Inglés y Checo'),
	((select id from country where name = 'Rumania'), 'Roxen', '', 2021, '', ''),
	((select id from country where name = 'Rusia'), '', '', 2021, '', ''),
	((select id from country where name = 'San Marino'), 'Senhit', '', 2021, '', ''),	
	((select id from country where name = 'Serbia'), 'Hurricane', 'Loco Loco', 2021, '', 'Serbio y Español'),
