...
insert into participant (country_id, name, song, year, song_link, language) values
	...
	((select id from country where name = 'Bélgica'), 'Hooverphonic', 'The Wrong Place', 2021, '', 'Inglés'),
	...
	((select id from country where name = 'Países Bajos'), 'Jeangu Macrooy', 'Birth of a New Age', 2021, '', 'Inglés y sranan tongo'),
	...
	((select id from country where name = 'Rumania'), 'Roxen', 'Amnesia', 2021, '', 'Inglés'),
